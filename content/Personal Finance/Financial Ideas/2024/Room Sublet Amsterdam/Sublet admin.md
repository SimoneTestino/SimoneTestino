...
date: 2024-09-05
---
Here I collect the financial consequences of my sporadic sublet in Amsterdam [[Sublet Homepage]]. This is a smaller versions of bigger projects like [[Airbnb in Amsterdam]] which may be realisable in the future. I also note that the project has been closed after the fine, see [[Lieven de Key Fine]].
...
***SHARED*** Double Room, 22m^2 (that is NOT a private room)
500€ - 700€ (depending on length of stay)
Short & Long Term

Hi! I am a 21yo Italian student living in a big 22 square meters room in the center of Amsterdam, in order to lower my rent I am looking for a room-mate. I am happy with both short (also only for a vacation) and long term; I am still unsure of the price, so I will consider offers, but it will certainly vary depending on the length of the stay. You can dm me on messages, or also send me a message on instagram: @simone.testino or on whatsapp: +39 339 637 9372. Hope to see you soon ^^

Videos of the room are available at: https://drive.google.com/drive/folders/1-7f7a5VgVAEEpvizZq2wrDy3f_JXPfSS

Prices for short term are listed here: https://horreum.pages.dev/3.-ExAcademia/Personal-Finance/Jobs/Room-Sublet/Sublet-Rates

Location and general information are here: https://horreum.pages.dev/3.-ExAcademia/Personal-Finance/Jobs/Room-Sublet/Sublet-Homepage