...
https://www1.cuni.cz/~svejdar/

[Course Announcement](https://www.dropbox.com/scl/fi/z17hbrrnhtg73xdh5owl1/IGTannouncement.pdf?rlkey=m5arjaoxwuexwwgr2bqmgbimt&dl=1)

Definition of $\omega$-consistency, there is a class sign r such that there is no proposition ($x$ Gen $r$ ) that neither $x$ Gen $r$ nor $\lnot (x$ Gen $r)$ belongs to the class of consequences. And here Gen is the generalisation, i.e. the universal quantifier. Idk try what that means but okay.
