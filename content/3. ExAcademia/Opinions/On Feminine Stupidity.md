...
[^2]: In [[Books#Dante]]e feminine gender deserves a far more complex analysis, the description given above covers only partially the feminine gender and only in technical environments like in the Convivio, crucially different, though not incoherent, with the one presented in Vita Nova.
[^3]: See "L'Ospite Inquietante" by [[Books#Galimberti]] also [Il Grido](https://youtu.be/M9zdwrVzjfA?si=4iUzviI6bTAO51Z3) by [[Books#Gaber]]both in Italian).

---
As always I am open to discussion (see [[4. System/Contacts/Contacts]]) and encourage the reader to leave [[Comments]].
