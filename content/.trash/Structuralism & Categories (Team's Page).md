...
title: Team's Page
---
This is a subpage of the [[Structuralism & Categories (Research Project)]].

Given the diversity [[Structuralism & Categories (Research Project)#Project Structure & Goals]] I think that there are three main fields we would need all student-force needed to best accomplish the end of the project:
...
## The Team
Other than me (I present myself already in [[Structuralism & Categories (Research Project)#Personal Resources of the Project]]), I will list here the other teammates. There currently are a few candidates, I will take the choice of the team more seriously once the supervision is guaranteed (see [[Structuralism & Categories (Supervisor's Page)]].
...
- **Structuralism**:
	- [SEP: Structural Realism, Ladyman](https://seop.illc.uva.nl/entries/structural-realism/)
		- Additional: [SEP: Structuralism in Physics](https://plato.stanford.edu/entries/physics-structuralism/)
...
- **Categorical Structuralism & Morita Equivalence**:
	- [[Halvorson, H., Tsementzis, D. (2015), Categories of Scientific Theories]]
	- [[Halvorson, H. (2015), Morita Equivalence]]
		- Additional for Mathematicians: [nLab Morita Equivalence](https://ncatlab.org/nlab/show/Morita+equivalence)
		- [SEP: Category-Theoretic Structuralism in Philosophy of Mathematics](https://plato.stanford.edu/entries/structuralism-mathematics/#CateTheoStru)
### Project's Tracks
