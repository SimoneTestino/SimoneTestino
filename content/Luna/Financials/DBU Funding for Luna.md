...
The DBU application is a two-stage process. The first step is the submission of a "Project sketch" (Projektskizze), which should be between 5 and 12 pages. If this sketch is evaluated positively, the DBU will then solicit a complete, formal application. All official guidelines and templates for this process can be found on the [DBU's download page](https://www.dbu.de/en/service/downloads/#application-process).